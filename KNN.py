...
#NO_OF_NEIGBHORS=int(sys.argv[2])
SIGMA=0.66
...
def main(trainSet,testSet,NO_OF_NEIGBHORS):
    ...
    #testError=getTestError(prediction,actualLabel)                      ##uncomment these to get test error individual
    #print("****Test Error*****")
    #print(testError)
    return prediction
#main()